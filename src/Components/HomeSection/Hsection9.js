      ...
      <div className="Hsection9 container">
        ...
        <div className="Hsection9_sec4">
          ...
          <div className="Hsection9_sec4_sec2">
            <p> The next challenge is starting VERY SOON!</p>

            <p>
              If this page is open, it means that the challenge is still open
              for registrations, but it will be closing down soon.{" "}
            </p>

            <p>
              And if you're wondering... well, can't I just take the challenge
              next time it opens up?
            </p>

            <p>Well, the answer is MAYBE...</p>

            <p>I'm not sure if or when the next challenge will be...</p>

            <p>
              But, more importantly, what about the people you could have served
              with your products or services that won't have a chance to hear
              about them, because you waited to launch your next funnel!
            </p>

            <p>
              There is an old Chinese proverb that says, "the best time to plant
              a tree was 20 years ago... but the 2nd best time, is NOW."
            </p>

            <p>
              NOW is the best time for you to take the 'One Funnel Away'
              challenge.
            </p>
          </div>
        </div>
        ...
        <div className="Hsection9_sec5">
          <div className="container">
            ...
            <p>
              If for some reason you don't feel like that is true, then you can
              email our support team within 30 days and receive a full refund of
              $100.{" "}
            </p>
